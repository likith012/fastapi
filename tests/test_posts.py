...
def test_put_one_post(authorized_client, post_create):
    response = authorized_client.put("/posts/1/", json={"title": "mellow", "content": "mellow World!", "published": False})
...
def test_create_post(authorized_client, post_create):
    response = authorized_client.post("/posts/", json={"title": "mellow", "content": "mellow World!", "published": False})
