...
def test_create_user(client):
    response = client.post("/users/", json={"email": "hello@gmail.com", "username": "hellouser", "password": "hello"})
...
def test_session(session):
    new_user = models.User(username="hellouser", email="hello@gmail.com", password="hello")
